...
Whenever a user calls a function, the interpreter can give them a hint as to what it does. The IDE displays the docstring to the user. Docstring syntax is a triple quote right after the function is defined.
