...
- The function should take the following arguments:
  ...
  - `l`: the distance from the center of mass of the AUV to the thrusters in meters.
  - `inertia` (can be set to default value of $100 kg \cdot m^2$): the moment of inertia of the AUV in $kg \cdot m^2$.
...
- The function should take the following arguments:
  ...
  - `mass` (can be set to default value of $100 kg$): the mass of the AUV in kilograms.
  - `inertia` (can be set to default value of $100 kg \cdot m^2$): the moment of inertia of the AUV in $kg \cdot m^2$.
  - `dt` (can be set to default value of $0.1 s$): the time step of the simulation in seconds.
  - `t_final` (can be set to default value of $10 s$): the final time of the simulation in seconds.
  - `x0` (can be set to default value of $0 m$): the initial $x$-position of the AUV in meters.
  - `y0` (can be set to default value of $0 m$): the initial $y$-position of the AUV in meters.
  - `theta0` (can be set to default value of $0 rad$): the initial angle of the AUV in radians.
