...
```zsh
cd && git clone --recurse-submodules https://github.com/ardupilot/ardupilot
cd ~/ardupilot
```
...
```zsh
~/ardupilot/Tools/autotest/sim_vehicle.py --vehicle=ArduSub --aircraft="bwsibot" -L RATBeach --out=udp:127.0.0.1:14550
```
...
```zsh
ros2 launch mavros apm.launch fcu_url:=udp://127.0.0.1:14550@14555 gcs_url:=udp://:14550@127.0.0.1:14550 tgt_system:=1 tgt_component:=1 system_id:=255 component_id:=240
```
