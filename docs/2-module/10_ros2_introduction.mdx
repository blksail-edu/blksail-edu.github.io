...
1. Configure the `.zshrc` file to source the ROS 2 installation. Using your favorite text editor, add the following line to the `.zshrc` file on the `backseat`.

```zsh
source /opt/ros/jazzy/setup.zs
```
...
5. Configure the `.zshrc` file to source the workspace and source the workspace. Using your favorite text editor, add the following line:
