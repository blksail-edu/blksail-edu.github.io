...
You should now see the ROV in QGroundControl. Commands performed by the `SITL` should be reflected in the Gazebo simulation, subject to the environmental constraints (pool walls and depth).
